                    ...
                    <div class="col-md-9 col-lg-9 col-sm-8 col-xs-12 float-left-style">
                        ...
                        <div class="slider__container slider--one">
                            <div class="slider__activation__wrap owl-carousel owl-theme">
                                <!-- Start Single Slide -->
                                <div class="slide slider__full--screen slider-height-inherit slider-text-right" style="background: rgba(0, 0, 0, 0) url({{asset('images/slider/bg/1.png')}} no-repeat scroll center center / cover ;">
                                    <div class="container">
                                        <div class="row">
                        ...
                        <div class="categories-menu mrg-xs">
                            ...
                            <div class="category-menu-list">
                                <ul>
                                        ...
                                        <div class="category-menu-dropdown">
                                            ...
                                            <div class="category-menu-dropdown-bottom">
                                                <div class="single-category-brand">
                                                    <a href="#"><img src="{{asset('frontend/images/brand/6.png')}}"></a>
                                                </div>
                                                <div class="single-category-brand">
                                                    <a href="#"><img src="{{asset('frontend/images/brand/7.png')}}"></a>
                                                </div>
                                                <div class="single-category-brand">
                                                    <a href="#"><img src="{{asset('frontend/images/brand/8.png')}}"></a>
                                                </div>
                                                <div class="single-category-brand">
                                                    <a href="#"><img src="{{asset('frontend/images/brand/9.png')}}"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li><a href="#"><img alt="" src="{{asset('frontend/images/icons/thum6.png')}}"> Men’s Clothing <i class="zmdi zmdi-chevron-right"></i></a>
                                        <div class="category-menu-dropdown">
                                            <div class="category-menu-dropdown-left">
                                    ...
                                    <li><a href="#"><img alt="" src="{{asset('frontend/images/icons/thum7.png')}}"> Bags & Shoes</a></li>
                                    <li><a href="#"><img alt="" src="{{asset('frontend/images/icons/thum8.png')}}"> Toys & Kids & Baby</a></li>
                                    <li><a href="#"><img alt="" src="{{asset('frontend/images/icons/thum9.png')}}">  Automobiles </a></li>
                                    <li><a href="#"><img alt="" src="{{asset('frontend/images/icons/thum10.png')}}"> Jewelry & Watches</a></li>
                                    <li><a href="#"><img alt="" src="{{asset('frontend/images/icons/thum2.png')}}"> Consumer Electronics</a></li>
                                    <li><a href="#"><img alt="" src="{{asset('frontend/images/icons/thum3.png')}}"> All Accessories</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/images/product/1.png')}}"product images">
                                                            </a>
                                                        </div>
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/images/product/2.png')}}"product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/images/product/3.png')}}"product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/images/product/4.png')}}"product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/images/product/5.png')}}"product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/images/product/6.png')}}"product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/images/product/8.png')}}"product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
                                            ...
                                            <div class="col-md-4 single__pro col-lg-4 cat--1 col-sm-4 col-xs-12">
                                                <div class="product">
                                                    <div class="product__inner">
                                                        <div class="pro__thumb">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/images/product/9.png')}}"product images">
                                                            </a>
                                                        </div>
                                                        <div class="product__hover__info">
                                                            <ul class="product__action">
